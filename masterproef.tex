...
\begin{abstract}
   ...
   However, the bioinformatics analysis of such data require multiple steps and parameter settings as well as increase computing resources. 
   Workflows along with computing infrastructures ease this need to a great extent;
   in this nontion, a Pipeline for environmental DNA Metabarcoding Analysis (\texttt{PEMA}) was developed (Chapter~\ref{publ:pema}). 
