...
% (\textit{how})
   ...
   % fector models describe how species abundance (x) variation depends on metabolite conce
   ...
   \label{subsec:ecol_interactions}
      ...
      In case of a negative interaction, can harm each other either way (\textbf{competition}). 
      ...
      % Ecological driver species, which exhibit a large impact on community structure and function, 
      % represent key nodes in the network that could be manipulated 
