...
\label{publ:pema}
   ...
   Cutadapt \cite{martin_cutadapt_2011} is used additionally for the case of ITS to address the variability in length of this marker gene (see Additional File 1: Supplementary Methods). 
   ...
   \subsection{PEMA modules added after its publication}
      ...
      Since its publication, PEMA has been under continuous development and testing.
