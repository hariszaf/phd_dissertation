...
\label{publ:pema}
   ...
   PEMA maps OTUs to a custom reference tree of 1,000 Silva-derived consensus sequences (created using RAxML-ng \citep{kozlov2019raxml} and gappa [phat algorithm] \citep{czech2019methods}, Figure~\ref{fig:pema-phylogeny-assignment}A). 
   ...
   Beyond the context of PEMA, users may visualize the output with tree viewers such as iTOL \citep{letunic2021interactive} (Figure~\ref{fig:pema-phylogeny-assignment}B).
   ...
   As previously, PEMA's performance was evaluated through a comparative analysis of the Bista et al. \citep{bista2017annual} dataset with \href{https://github.com/enormandeau/barque}{Barque}\footnote{\href{https://github.com/enormandeau/barque}{https://github.com/enormandeau/barque}}; 
