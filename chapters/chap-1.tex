...
\label{publ:pema}
   ...
   \begin{table}[]
      \begin{center}    
         ...
         \end{tabular}
         \caption[PEMA'sa output and execution time]{PEMA'sa output and execution time; PEMA's output and execution time (using a 20-core node) for different values of Swarm's d parameter.}
