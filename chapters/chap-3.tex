...
\label{sec:experiments}
   ...
   \begin{figure*}[t!]
      ...
      \caption[Comparison of Recon2 and Recon3D flu]{Estimation, using our tools, of the marginal distribution of 6 reaction fluxes in two constraint-based model of Homo Sapiens metabolism, namely Recon2D~\cite{swainston16} (blue color) and Recon3D~\cite{brunk2018recon3d} (red color).
